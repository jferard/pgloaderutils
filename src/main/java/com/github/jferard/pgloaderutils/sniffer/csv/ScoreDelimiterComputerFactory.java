...
public class ScoreDelimiterComputerFactory implements DelimiterComputerFactory {
    private final int[] delimiterScores;
    private final int minDelimiters;

    ScoreDelimiterComputerFactory(final int[] delimiterScores, final int minDelimiters) {
    ...
    public ByteComputer create(final List<Line> lines) {
        return new ScoreDelimiterComputer(lines, delimiterScores, minDelimiters);
    }
}
