...
public class ScoreEscapeComputerFactory implements EscapeComputerFactory {
    private final int[] escapeScore;

    public ScoreEscapeComputerFactory(final int[] escapeScore) {
    ...
    public ByteComputer create(final List<Line> lines, final byte finalDelimiter, final byte finalQuote) {
        return new ScoreEscapeComputer(lines, finalDelimiter, finalQuote, escapeScore);
    }
}
