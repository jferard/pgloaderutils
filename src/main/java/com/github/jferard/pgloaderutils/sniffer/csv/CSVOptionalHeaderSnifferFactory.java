...
public class CSVOptionalHeaderSnifferFactory implements OptionalHeaderSnifferFactory {
    @Override
    public OptionalHeaderSniffer create(final byte delimiter,
                                        final byte quote, final byte escape,
