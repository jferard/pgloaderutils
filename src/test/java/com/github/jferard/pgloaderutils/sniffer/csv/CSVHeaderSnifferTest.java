...
public class CSVHeaderSnifferTest {
    ...
    private CSVOptionalHeaderSnifferFactory headerSnifferFactory;

    @Before
    public void setUp() {
        this.joiner = Joiner.on('\n');
        this.headerSnifferFactory = new CSVOptionalHeaderSnifferFactory();
    }

    @Test
    public final void testWithHeader() throws IOException {
        final OptionalHeaderSniffer csvHeaderSniffer = this.headerSnifferFactory
                .create((byte) ',', (byte) 0, (byte) 0, ASCII);
    ...
    public final void test3() throws IOException {
        ...
        final InputStream stream =
                Resources.getResource("sirc-17804_9075_14209_201612_L_M_20170104_171522721-part" +
                        ".csv").openStream();
        csvHeaderSniffer.sniff(stream, 100000);
        Assert.assertEquals(
                Arrays.asList("SIREN", "NIC", "L1_NORMALISEE", "L2_NORMALISEE", "L3_NORMALISEE",
                        "L4_NORMALISEE", "L5_NORMALISEE", "L6_NORMALISEE", "L7_NORMALISEE",
                        "L1_DECLAREE", "L2_DECLAREE",
                        "L3_DECLAREE", "L4_DECLAREE", "L5_DECLAREE", "L6_DECLAREE", "L7_DECLAREE",
                        "NUMVOIE", "INDREP",
                        "TYPVOIE", "LIBVOIE", "CODPOS", "CEDEX", "RPET", "LIBREG", "DEPET",
                        "ARRONET", "CTONET", "COMET",
                        "LIBCOM", "DU", "TU", "UU", "EPCI", "TCD", "ZEMET", "SIEGE", "ENSEIGNE",
                        "IND_PUBLIPO", "DIFFCOM",
                        "AMINTRET", "NATETAB", "LIBNATETAB", "APET700", "LIBAPET", "DAPET", "TEFET",
                        "LIBTEFET", "EFETCENT",
                        "DEFET", "ORIGINE", "DCRET", "DATE_DEB_ETAT_ADM_ET", "ACTIVNAT", "LIEUACT",
                        "ACTISURF", "SAISONAT",
                        "MODET", "PRODET", "PRODPART", "AUXILT", "NOMEN_LONG", "SIGLE", "NOM",
                        "PRENOM", "CIVILITE", "RNA",
                        "NICSIEGE", "RPEN", "DEPCOMEN", "ADR_MAIL", "NJ", "LIBNJ", "APEN700",
                        "LIBAPEN", "DAPEN", "APRM",
                        "ESSEN", "DATEESS", "TEFEN", "LIBTEFEN", "EFENCENT", "DEFEN", "CATEGORIE",
                        "DCREN", "AMINTREN",
                        "MONOACT", "MODEN", "PRODEN", "ESAANN", "TCA", "ESAAPEN", "ESASEC1N",
                        "ESASEC2N", "ESASEC3N",
                        "ESASEC4N", "VMAJ", "VMAJ1", "VMAJ2", "VMAJ3", "DATEMAJ"),
                csvHeaderSniffer.getHeader());
    }
}
